# Generated by Django 2.0.6 on 2018-06-24 19:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, unique=True)),
                ('desc', models.TextField(blank=True, max_length=500, verbose_name='Description')),
                ('image', models.ImageField(blank=True, max_length=150, upload_to='images/characters/')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, unique=True)),
                ('desc', models.TextField(blank=True, max_length=500, verbose_name='Description')),
                ('image', models.ImageField(blank=True, max_length=150, upload_to='images/creators/')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cvurl', models.URLField(blank=True, verbose_name='ComicVine URL')),
                ('name', models.CharField(blank=True, max_length=350, verbose_name='Issue Name')),
                ...
                ('image', models.ImageField(blank=True, max_length=150, upload_to='images/issues/', verbose_name='Cover Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cvid', models.PositiveIntegerField(null=True, verbose_name='Comic Vine ID')),
                ('cvurl', models.URLField(verbose_name='Comic Vine URL')),
                ('name', models.CharField(max_length=200, verbose_name='Series Name')),
                ('slug', models.SlugField(max_length=200, unique=True)),
                ('desc', models.TextField(blank=True, max_length=500, verbose_name='Description')),
                ('image', models.ImageField(blank=True, max_length=150, upload_to='images/publishers/')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ManyToManyField(to='comics.Role')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cvid', models.PositiveIntegerField(unique=True, verbose_name='Comic Vine ID')),
                ('cvurl', models.URLField(blank=True, verbose_name='Comic Vine URL')),
                ('name', models.CharField(max_length=200, verbose_name='Series Name')),
                ('slug', models.SlugField(max_length=200, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, unique=True)),
                ('desc', models.TextField(blank=True, max_length=500, verbose_name='Description')),
                ('image', models.ImageField(blank=True, max_length=150, upload_to='images/teams/')),
            ],
            options={
                'ordering': ['name'],
            },
